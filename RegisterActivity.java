...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void postDataToSQLite() {
        if (!inputValidation.isInputEditTextFilled(textInputEditTextName, textInputLayoutName, getString(R.string.empty_message_name))) {
            return;
        }
        ...
        if (!inputValidation.isInputEditTextFilled(textInputEditTextConfirmPassword, textInputLayoutConfirmPassword, getString(R.string.empty_message_confirmpassword))) {
            return;
        }
        ...
        if (!inputValidation.isInputEditTextCount(textInputEditTextPassword, textInputLayoutPassword, getString(R.string.error_less_password))) {
            return;
        }
        if (!inputValidation.isInputEditTextCount(textInputEditTextConfirmPassword, textInputLayoutConfirmPassword, getString(R.string.error_less_password))) {
            return;
        }
